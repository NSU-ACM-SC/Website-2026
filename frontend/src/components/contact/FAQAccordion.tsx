...
export const FAQAccordion: React.FC = () => {
  ...
  const categories = ["All", "General", "Membership", "SIGs & Projects", "Events & Workshops", "Research"];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-white border-2 border-black font-body text-sm font-medium shadow-[4px_4px_0px_0px_#000] focus:outline-none focus:bg-[#f1eee7]"
          />
        </div>
        ...
        <div className="space-y-4">
          {filteredFaqs.length === 0 ? (
            <div className="bg-white border-2 border-black p-8 text-center shadow-[4px_4px_0px_0px_#000]">
            ...
            filteredFaqs.map((faq) => {
              ...
              return (
                <div
                  key={faq.id}
                  className="bg-white border-[3px] border-black shadow-[4px_4px_0px_0px_#000000] overflow-hidden transition-all"
                >
                  <button
                    type="button"
                  ...
                  >
                    <div className="space-y-1">
                      <span className="bg-[#5227FF] text-white px-2 py-0.2 text-[10px] font-display font-black uppercase inline-block">
                        {faq.category}
                      </span>
                    ...
                    <div
                      className={`p-2 bg-black text-white shrink-0 transition-transform duration-200 ${
                  ...
                  {isOpen && (
                    <div className="p-5 pt-0 border-t-2 border-black/10 bg-[#f1eee7]/50 font-body text-sm text-black/85 leading-relaxed">
